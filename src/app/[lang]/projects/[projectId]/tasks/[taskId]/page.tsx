        ...
        <div className={styles.headerActions}>
          {canUpdateWorkflow ? (
            <form action={updateTaskWorkflowStatus}>
              ...
              <button className={styles.primaryAction} name="status" type="submit" value={nextTaskStatus[task.status]}>
          ...
          {timerIsForTask && activeTimer ? (
            <form action={stopTaskTimer}>
              ...
              <button className={styles.stopAction} type="submit">{isArabic ? "إيقاف وحفظ" : "Stop & save"}</button>
            </form>
          ) : timerCanStart ? (
            <form action={startTaskTimer}>
              ...
              <input name="projectId" type="hidden" value={projectId} />
              <input name="taskId" type="hidden" value={taskId} />
              <button className={styles.timerAction} type="submit">{isArabic ? "بدء التايمر" : "Start timer"}</button>
            </form>
          ) : null}
        </div>
      </header>
        ...
        <main className={styles.mainColumn}>
          ...
          <section className={styles.panel}>
            ...
            <form action={addTaskComment} className={styles.commentForm}>
              ...
              <button className={styles.primaryAction} type="submit">{isArabic ? "إضافة تعليق" : "Add comment"}</button>
            </form>
          </section>
        </main>
        ...
        <aside className={styles.sideColumn}>
          ...
          {canManageTasks ? (
            <details className={styles.panel} open>
              ...
              <form action={updateTaskDetails} className={styles.form}>
                ...
                <button className={styles.primaryAction} type="submit">{isArabic ? "حفظ التعديلات" : "Save changes"}</button>
              </form>
              {task.status !== "CANCELLED" ? <form action={archiveTask} className={styles.archiveForm}><input name="locale" type="hidden" value={lang} /><input name="projectId" type="hidden" value={projectId} /><input name="taskId" type="hidden" value={taskId} /><button type="submit">{isArabic ? "أرشفة التاسك" : "Archive task"}</button></form> : null}
            </details>
          ) : null}
          ...
          {canManageTasks ? (
            <details className={styles.panel}>
              ...
              <form action={createSubtask} className={styles.form}>
                ...
                <button className={styles.primaryAction} type="submit">{isArabic ? "إضافة" : "Add subtask"}</button>
              </form>
            </details>
          ) : null}
          ...
          <section className={styles.panel}>
            ...
            {oneDriveConnection ? <form action={uploadTaskAttachment} className={styles.form}>
              ...
              <button className={styles.primaryAction} type="submit">{isArabic ? "رفع إلى OneDrive" : "Upload to OneDrive"}</button>
            ...
            <details className={styles.linkDetails}>
              ...
              <form action={addTaskAttachment} className={styles.form}>
                ...
                <button className={styles.secondaryAction} type="submit">{isArabic ? "إضافة الرابط" : "Add link"}</button>
              </form>
            </details>
          </section>
